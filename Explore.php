...
<body>
    ...
    <main>
        <section class="explore">
            <div class="container">
                <div class="row">
                    <h2 class="text-center explore__heading">Explore Foods</h2>
                    <div class="col-4 c-12 position-relative">
                        <img src="./images/pizza.jpg" class="explore__img img-fluid" alt="...">
                        <span class="explore__img-title">Pizza</span>
                    </div>
                    <div class="col-4 c-12 position-relative">
                        <img src="./images/burger.jpg" class="explore__img img-fluid" alt="...">
                        <span class="explore__img-title">Burger</span>
                    </div>
                    <div class="col-4 c-12 position-relative">
                        <img src="./images/momo.jpg" class="explore__img img-fluid" alt="...">
                        <span class="explore__img-title">Momo</span>
                    </div>
                    <div class="col-4 c-12">
                        <div class="explore__order d-flex align-items-center">
                            <div class="explore__order-title">
                                <b>Food - Order Website</b> (Part 1) <br>
                                <span>PHP & MySQL</span>
                            </div>
                        </div>
                    </div>
